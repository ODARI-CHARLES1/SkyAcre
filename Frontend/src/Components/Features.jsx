...
const Features = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="text-center mb-20">
      ...
      <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">Explore the key features that make smarter,more sustainable agriculture possible.</p>
