...
const ResourceSteps = () => {
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap flex-col">
    ...
    <div class="flex flex-col text-center w-full">
      <h1 class="text-xl font-medium title-font mb-4 text-gray-900">Our Vision</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Revolutionize agriculture with technology to ensure healthy crops and higher felds.</p>
    </div>
  </div>
</section>
    </>
